...
public class EncoderPositions extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Pitch (Degrees): ", robot.mecanumDrive.lazyImu.get().getRobotYawPitchRollAngles().getPitch(AngleUnit.DEGREES));
        telemetry.addData("Roll (Degrees): ", robot.mecanumDrive.lazyImu.get().getRobotYawPitchRollAngles().getRoll(AngleUnit.DEGREES));

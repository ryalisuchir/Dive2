...
public class CloseSpecimen1Basket3 extends OpMode {
    ...
    public void start() {
        ...
        Action movement2 = robot.driveSubsystem.trajectoryActionBuilder(new Pose2d(7.23, 31.78, Math.toRadians(270)))
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(48.15, 47.2, Math.toRadians(90)), Math.toRadians(-90.00))
                .build();

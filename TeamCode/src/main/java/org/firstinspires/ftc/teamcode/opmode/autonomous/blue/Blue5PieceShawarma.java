...
public class Blue5PieceShawarma extends OpMode { //may veer bless us
    ...
    public void init() {
        ...
        movement1 = robot.driveSubsystem.whatTheSigma(Globals.BLUE_SIDEWAYS_START_POSE)
                .splineToLinearHeading(
                        new Pose2d(62.5, 59.5, Math.toRadians(45)), Math.toRadians(45),
                        null,
        ...
        movement9 = robot.driveSubsystem.whatTheSigma(new Pose2d(27, 0, Math.toRadians(0)))
                ...
                .splineToSplineHeading(
                        new Pose2d(62, 55, Math.toRadians(45.00)), Math.toRadians(45.00),
    ...
    public void init_loop() {
        ...
        if (isLocked) {
            ...
            telemetry.addData("Description: ", "5 Samples");
    ...
    public void loop() {
        ...
        if (isScanning) {
            ...
            if (!Double.isNaN(greenAngle)) {
                ...
                lastEstimate = angle;
                Log.i("Successful Scan (Red 0+5):", "xTravel: " + xTravel + "yTravel: " + yTravel);
                isScanning = false;
            } else {
                angle = lastEstimate;
            }

...
public class MecanumDrive {
    ...
    public static class Params {
        ...
        public double kS = 1.5671283484155358; //0.15
        public double kV = 0.135;
        public double kA = 0.038;


        // path profile parameters (in inches)
        public double maxWheelVel = 72;
        public double minProfileAccel = -45; //so uhh making this -60 was NOT a good idea!
        public double maxProfileAccel = 85;

        // turn profile parameters (in radians)
        public double maxAngVel = Math.PI; // shared with path
        public double maxAngAccel = 5; //This might screw everything up but it's okay! Was Math.PI before

        // path controller gains
        public double axialGain = 4.2; //4.2
        public double lateralGain = 6.3; //6.3
        public double headingGain = 8; // shared with turn - 8
    ...
    //edited extra correction one:
    public final class FollowTrajectoryActionWithCorrection implements Action {
        public final TimeTrajectory timeTrajectory;
        private final double[] xPoints, yPoints;
        private double beginTs = -1;

        public FollowTrajectoryActionWithCorrection(TimeTrajectory t) {
            timeTrajectory = t;

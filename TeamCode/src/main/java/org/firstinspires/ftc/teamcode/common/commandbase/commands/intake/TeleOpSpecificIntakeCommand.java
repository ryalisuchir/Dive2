...
public class TeleOpSpecificIntakeCommand extends SequentialCommandGroup {

    public TeleOpSpecificIntakeCommand(RobotHardware robot, double intakeRotation, double extendoPosition) {
        super(

...
public class YellowAngleDetection extends OpenCvPipeline
{
    ...
    void findContours(Mat input) {
        ...
        Core.inRange(hsvMat, YELLOW_LOWER_BOUND, YELLOW_UPPER_BOUND, yellowThresholdMat); //I added this but it might be stupid idrk

        Core.extractChannel(ycrcbMat, cbMat, 2); // Cb channel index is 2
        Imgproc.threshold(cbMat, yellowThresholdMat, YELLOW_MASK_THRESHOLD, 255, Imgproc.THRESH_BINARY);

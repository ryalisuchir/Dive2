...
public class BlueBucket6Sample extends OpMode {
    ...
    public void init() {
        ...
        TrajectoryActionBuilder movement1 = robot.driveSubsystem.trajectoryActionBuilder(Globals.BLUE_SIDEWAYS_START_POSE)
                .splineToLinearHeading(new Pose2d(65.6, 56, Math.toRadians(45)), Math.toRadians(45));
        ...
        TrajectoryActionBuilder movement8 = movement7.endTrajectory().fresh()
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(35.96, 10.00, Math.toRadians(0)), Math.toRadians(180.00))
                .splineToSplineHeading(
                        new Pose2d(21.00, 10.00, Math.toRadians(0)), Math.toRadians(180.00)
                );
